...
// Stopped is a hibernate resume; Error is allowed because restore rebuilds the run dir and is the recovery path out of a crashed restore, which would otherwise dead-end at vm rm.
