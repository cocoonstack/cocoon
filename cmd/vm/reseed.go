...
// reseedAfterResume detaches by default: the post-resume vsock dial would otherwise sit on every clone/restore critical path.
...
// reseedVM retries only a failed dial: the agent re-listens shortly after resume.
