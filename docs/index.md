...
- **Interactive console** — `cocoon vm console` with bidirectional PTY relay, an SSH-style escape sequence (`^]` disconnects; `--escape-char` changes it), SIGWINCH propagation
